...
const OnSalePage = ({ onShowCart, onShowLikes }) => {
    ...
    // Get products for the on sale category
    const products = getProductsByCategorySlug('exclusive-offers', 'sale')
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                        {products.map((product) => (
                            <div
                                key={product.id}
                                onClick={() => navigate(`/on-sale/exclusive-offers/${product.id}`)}
