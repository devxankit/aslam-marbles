...
const CartModal = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed right-0 top-0 h-full w-full sm:w-96 md:w-[450px] bg-white z-[115] shadow-2xl transform transition-transform duration-500 ease-out overflow-y-auto ${isOpen ? 'translate-x-0' : 'translate-x-full'
          } ${!isOpen ? 'pointer-events-none' : ''}`}
      >
        <div className="flex items-center justify-between p-4 md:p-6 border-b border-gray-200 sticky top-0 bg-white z-10">
          <h2 className="text-xl md:text-2xl font-bold text-black uppercase"><TranslatedText>Shopping Cart</TranslatedText></h2>
          <button
            onClick={onClose}
        ...
        <div className="p-4 md:p-6">
          {cartItems.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 text-lg"><TranslatedText>Your cart is empty</TranslatedText></p>
            </div>
          ) : (
            <div className="space-y-4">
              ...
              <div className="border-t border-gray-200 pt-4 mt-4">
                <div className="flex justify-between items-center mb-4">
                  <span className="text-lg font-semibold text-gray-800"><TranslatedText>Total:</TranslatedText></span>
